...
.post(cors.corsWithOptions, authenticate.verifyAdmin, categoryUpload.single('imageFile'), (req, res) => {
    res.statusCode = 200;
    res.setHeader('Content-Type', 'application/json');
    res.json(req.file);
})
...
.post(cors.corsWithOptions, authenticate.verifyAdmin, productUpload.single('imageFile'), (req, res) => {
    res.statusCode = 200;
    res.setHeader('Content-Type', 'application/json');
    res.json(req.file);
})
...
.post(cors.corsWithOptions, profilePictureUpload.single('imageFile'), (req, res) => {
    res.statusCode = 200;
    res.setHeader('Content-Type', 'application/json');
    res.json(req.file);
})
